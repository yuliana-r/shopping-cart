...
function Product({ product }) {
  return(
    <div className='flex flex-col items-center justify-between w-56 m-2 border-2 border-solid rounded shadow-md border-silver-400 h-96'>
      ...
      <div className='flex flex-row items-center justify-between w-3/4 p-2'>
        <select name="quantity" id="quantity" className='w-12 text-center border-2 border-solid text-black-900 border-silver-500 h-7 bg-silver-100'>
