export default function CartItem(props) {
  return(
    ...
    <div className='flex items-center h-[110px] justify-between w-full gap-2 mb-4 border border-solid rounded shadow-md border-silver-400 font-display'>
      <div className='flex items-center justify-start w-5/6 font-display'>
        <div className='w-[85px] overflow-hidden h-full p-4'>
      ...
      <p className="w-[100px] font-medium tracking-wider text-right pr-4 text-black-950">£{props.totalPricePerItem.toFixed(2)}</p>
    </div>
  )
}