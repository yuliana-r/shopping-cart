...
export default function Cart(props) {
  ...
  return (
    <>
      ...
      <div className='mt-[230px] flex flex-col items-center w-6/12 min-w-[350px] mt-6 font-display'>
        <div className='flex items-center justify-between w-full gap-2 mb-2 text-lg font-bold text-black-800'>
          ...
          <p className='text-center w-[50px]'>Qty</p>
        ...
        <button className="self-center w-56 px-5 py-1 m-4 text-base font-semibold border border-solid rounded bg-navy-500 border-navy-700 text-black-50 hover:scale-105 group">
