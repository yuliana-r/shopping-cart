...
const ErrorPage = () => {
  return (
    <div className='flex flex-col items-center justify-center w-screen h-screen gap-4 m-auto text-2xl font-semibold text-center bg-silver-100 font-display text-silver-900'>
