...
export default function Home(props) {
  return(
    <>
      ...
      <div className="mt-[240px] xs:mt-[200px] flex flex-col items-center justify-center w-full m-2 text-lg leading-7 text-justify select-none h-fit font-display text-black-950">
